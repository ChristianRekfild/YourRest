...
{
    public class RoomControllerTest : IClassFixture<SingletonApiTest> //ApiTest
    {
        ...
        public async Task GetAllRoom_ReturnsExpectedRoom_WhenDatabaseHasRoom()
        {
            ...
            var expectedRoom1 = new Room { Name ="Lyxar", AccommodationId = 1, Capacity = 20, Id = 20, SquareInMeter = 30, RoomType = "Lyx" };
